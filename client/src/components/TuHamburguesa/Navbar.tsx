  ...
  return (
    <NavbarContainer>
      ...
      <Header>
        ...
        <Headermiddle>
          <Link to="/tuhamburguesa">
            <Logo>Tu Hamburguesa</Logo>
          </Link>
        ...
        <Headerbottom>
          <Infocategories>
            <div className="infocategories-item">PROMOS</div>
            <div className="infocategories-item">HAMBURGUESAS</div>
            <div className="infocategories-item">BEBIDAS</div>
            <div className="infocategories-item">POSTRES</div>
            <div className="infocategories-item"></div>
          </Infocategories>
        </Headerbottom>
      </Header>
    </NavbarContainer>
