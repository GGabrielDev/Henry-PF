...
const { selectCartQuantity, selectIsOpen } = cartSelectors;
const { selectSeller } = sellerSelectors;

const Navbar = () => {
  const dispatch = useAppDispatch();
  const seller = useAppSelector(selectSeller) as NonNullable<SellerType>;
  ...
  return (
    <NavbarContainer>
      ...
      <Header>
        ...
        <Headermiddle>
          <Link to={`/shop/${seller.nombreUrl}`}>
            <Logo>{seller.nombreNegocio}</Logo>
          </Link>
